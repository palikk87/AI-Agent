...
<environment>
  Self-hosted. You DO manage git: commit and push your own work.
  The user views the app in a browser. Environment variables live in the Render
  dashboard (and render.yaml); ask the owner to set secrets there when needed.
